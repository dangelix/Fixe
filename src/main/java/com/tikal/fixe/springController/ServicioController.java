package com.tikal.fixe.springController;
...
import com.tikal.fixe.dao.FacturaDAO;
...
import com.tikal.fixe.dao.FolioDAO;
import com.tikal.fixe.modelo.Compra;
import com.tikal.fixe.modelo.RegistroBitacora;
import com.tikal.fixe.modelo.Response;
import com.tikal.fixe.util.EmailSender;
import com.tikal.fixe.util.JsonConvertidor;
import com.tikal.fixe.util.PDFFactura;
...
public class ServicioController {
	...
	public void facturar(HttpServletRequest req, HttpServletResponse res, @RequestBody String json) throws IOException{
		...
		String cadenaComprobante = com.tikal.fixe.util.Util.marshallComprobante(comprobante);
	...
	private Comprobante getComprobante(Receptor receptor, Compra compra) {
		...
		comprobante.setFecha(com.tikal.fixe.util.Util.getXMLDate( new Date() ) );
